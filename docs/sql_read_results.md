...
Cohort 2024A had the highest average pre-work score (81.8). This may indicate that students in this cohort were slightly more prepared in the pre-work material compared to other cohorts.
...
There are 8 students who scored 80 or above. Most of them are from Jordan, with a few from Palestine and one from Egypt, which suggests high performers are not limited to one country.

**Question 3:** From the JOIN results (Query 4): choose one student and describe their project submission pattern.

For example, :contentReference[oaicite:0]{index=0} consistently submitted all projects (Laptop Verify, Python Env, PR Hygiene) with relatively high grades, which suggests strong and steady engagement with the coursework.